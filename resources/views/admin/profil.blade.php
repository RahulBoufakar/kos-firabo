...
<div x-data="{
    ...
    <div class="row g-3">
                ...
                <form method="POST" action="{{ route('admin.profil.update') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <small style="font-size:11px; color:#9ca3af;">
                            <i class="bi bi-lock me-1"></i>Email admin tidak dapat diubah
                        </small>
                    </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="firabo-card h-100">
                <h6 class="card-title mb-4">Detail Akun</h6>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <p class="mb-1 text-muted" style="font-size:13px;">Role</p>
                        <span class="badge-tersedia px-3 py-2" style="border-radius:6px;">
                            Admin
                        </span>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <p class="mb-1 text-muted" style="font-size:13px;">Status Akun</p>
                        <span class="badge-tersedia px-3 py-2" style="border-radius:6px;">
                            Aktif
                        </span>
                    </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <p class="mb-1 text-muted" style="font-size:13px;">Bergabung Sejak</p>
                ...
                <div class="mt-4 p-3 rounded"
                    ...
                    <p class="mb-0 text-muted text-center" style="font-size:12px;">
                        ...
                        Akun admin dibuat langsung oleh sistem dan tidak dapat didaftarkan secara publik.
                    </p>
                </div>
            </div>
        </div>
